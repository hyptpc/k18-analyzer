...
public:
  ...
  genfit::MeasuredStateOnPlane GetFitState(int trackid, int pointid=0) const;
  ...
  TVector3 GetMom(int trackid, int pointid) const;
  TVector3 GetPos(int trackid, int pointid) const;
  ...
  void FinalizeGFTracks(std::vector<TPCTrack*> &tpcTrackArray);
  void GetMomentumWithVertex(genfit::Track *gfTrack, TVector3 posVertex, TVector3 &momVertex, TVector3 &pocVertex) const;
