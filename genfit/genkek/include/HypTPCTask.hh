...
public:
  ...
  bool ExtrapolateTrack(int trackid, double distance, TVector3 &pos, TVector3 &mom, TMatrixD &cov, int repid=-1) const;
  ...
  bool FindVertex(int trackid1, int trackid2, int repid1, int repid2,
    double &extrap_dist1, double &extrap_dist2, TVector3 &mom_vertex1, TVector3 &mom_vertex2,
    double &distance, TVector3 &vertex, double scan_range=100.) const;
  bool FindVertex(int trackid1, int trackid2, int repid1, int repid2,
    double &extrap_dist1, double &extrap_dist2, TVector3 &mom_vertex1, TVector3 &mom_vertex2,
    double &distance, TVector3 &vertex,
    TMatrixD &cov_vertex1, TMatrixD &cov_vertex2,
    TVector3 &track1_vertex, TVector3& track2_vertex, double scan_range=100.) const;
  bool FindVertexXi(int trackid, int repid, TVector3 decayvtx_lambda, TVector3 mom_lambda,
    double &tracklen_lambda, double &extrap_dist_pi, TVector3 &mom_pi_vertex,
    double &distance, TVector3 &vertex,
    double scan_range=100., double res1 = 1,double res2 = 1, double phi = 0) const;
  bool FindVertexXi(int trackid, int repid, TVector3 decayvtx_lambda, TVector3 mom_lambda,
    double &tracklen_lambda, double &extrap_dist_pi, TVector3 &mom_pi_vertex,
    double &distance, TVector3 &vertex,
