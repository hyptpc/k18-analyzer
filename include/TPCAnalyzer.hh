...
public:
  ...
  //Refit TPC Tracks after vertexing
  Bool_t ConstructEventTracks(const Int_t ntracks,
				const std::vector<Int_t>& isK18,
				const std::vector<Int_t>& isKurama,
				const std::vector<Int_t>& isAccidental,//should be included or not?
				const std::vector<Int_t>& isBeam,//should be included or not?
				const std::vector<Int_t>& charge,
