...
public:
  ...
  Double_t GetMint() const { return m_min_t; } //minumum theta of the helix track
  Double_t GetMaxt() const { return m_max_t; } //maximum theta of the helix track
  ...
  Int_t GetIsK18() const { return m_isK18; } //the beam track matched with the beam chamber tracking result
  ...
  //Convert the high-mom straightline-like track into helix track
