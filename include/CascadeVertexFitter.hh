#ifndef CascadeVertexFitter_h
#define CascadeVertexFitter_h
...
class CascadeVertexFitter: virtual public KinematicFitter{
	...
	protected:	
		...
		*/
		...
		double t;//Lambda extrapolation parameter.
		double t_cor;

		bool UseVertexFlag = 0;
	public:
		CascadeVertexFitter(){}
		CascadeVertexFitter(TLorentzVector P_,TVector3 V_P,
			TLorentzVector Q_,TVector3 V_Q,
			TLorentzVector R_,TVector3 V_R);
		...
		vector<TVector3> GetFittedVerticies(){
			vector<TVector3> ret = {VPCor,VQCor,VRCor,VLCor,VXCor};
			return ret;
		}
