#ifndef CascadeFitter2_h
#define CascadeFitter2_h
...
class CascadeFitter2: virtual public KinematicFitter{
	...
	public:
		CascadeFitter2(){}
		CascadeFitter2(TLorentzVector P_,TLorentzVector Q_,TLorentzVector R_);
