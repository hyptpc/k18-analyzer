#ifndef FourVectorCartesianFitter_h
#define FourVectorCartesianFitter_h
#include "KinFit.hh"
#include <TVector3.h>
...
class FourVectorCartesianFitter: virtual public KinematicFitter{
	//R -> P + Q;
	protected:	
		TLorentzVector P;
		TVector3 Pres;
		...
		bool MeasDir = false;
	public:
		FourVectorCartesianFitter(){}
		FourVectorCartesianFitter(TLorentzVector P_,TLorentzVector Q_,TLorentzVector R_);
