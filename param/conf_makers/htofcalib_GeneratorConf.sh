#!/bin/bash
rm -rf ../conf_htofcalib/*
set -o noclobber
for run in {5721,5764}
do
    file="../conf_htofcalib/analyzer_0$run.conf"
    echo "$file"
    ...
    echo "HDPRM:		param/HDPRM/HodoParam_E42_20231216">>$file
    ...
    echo "#TPCPOS:		param/TPCPOS/TPCPositionCorrectionMap_230820">>$file
