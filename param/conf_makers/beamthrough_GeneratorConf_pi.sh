#!/bin/bash
set -o noclobber
#for run in {5808,5811,5814,5818,5821,5824,5828,5831,5837,5838,5840,5844,5851,5855,5858,5862,5864} #pi after BH2 modification
for run in {5808,5811,5814,5818,5821,5824,5828,5831,5840,5844,5851,5855,5858,5862,5864} #pi after BH2 modification
################
do
    ...
    echo "USER:		param/USER/beamthrough/UserParam_E42_beamthrough_pi_$run">>$file
