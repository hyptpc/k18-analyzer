...
namespace
{
  ...
  using namespace dst;
  using namespace std;
  const std::string& class_name("DstTPCKuramaK18TrackingGeant4");
...
struct Event
{
  ...
  vector<Int_t> isG4Kurama;
  vector<Int_t> isK18;
  vector<Int_t> isG4K18;
  ...
  //WC
  Int_t nhWc;
  std::vector<Double_t> WcSeg;
  std::vector<Double_t> tWc;
  std::vector<Double_t> dtWc;
  std::vector<Double_t> deWc;
  std::vector<Double_t> posWc;
  std::vector<Int_t> G4tidWc;
  ...
  //nhTPCVp
  Int_t nhTPCVp;
  std::vector<Int_t> tidTPCVp;
  std::vector<Int_t> pidTPCVp;
  std::vector<Int_t> didTPCVp;
  std::vector<Int_t> prtTPCVp;
  std::vector<Int_t> qTPCVp;
  std::vector<Double_t> xTPCVp;
  std::vector<Double_t> yTPCVp;
  std::vector<Double_t> zTPCVp;
  std::vector<Double_t> pxTPCVp;
  std::vector<Double_t> pyTPCVp;
  std::vector<Double_t> pzTPCVp;
  std::vector<Double_t> ppTPCVp;
  std::vector<Double_t> deTPCVp;
  std::vector<Double_t> tTPCVp;
...
struct Src
{
  ...
  //TPCVp;
  Int_t nhTPCVp;
  Int_t tidTPCVp[MaxG4Hits];
  Int_t pidTPCVp[MaxG4Hits];
  Int_t didTPCVp[MaxG4Hits];
  Int_t prtTPCVp[MaxG4Hits];
  Int_t qTPCVp[MaxG4Hits];
  Double_t xTPCVp[MaxG4Hits];
  Double_t yTPCVp[MaxG4Hits];
  Double_t zTPCVp[MaxG4Hits];
  Double_t pxTPCVp[MaxG4Hits];
  Double_t pyTPCVp[MaxG4Hits];
  Double_t pzTPCVp[MaxG4Hits];
  Double_t ppTPCVp[MaxG4Hits];
  Double_t deTPCVp[MaxG4Hits];
  Double_t tTPCVp[MaxG4Hits];
...
dst::DstRead( int ievent )
{
  ...
  for(int ih=0;ih<event.nhWc;++ih){
    event.WcSeg.push_back(src.didWc[ih]);
    event.tWc.push_back(src.tWc[ih]);
    event.deWc.push_back(src.deWc[ih]);
    event.posWc.push_back(src.yWc[ih]);
    event.G4tidWc.push_back(src.tidWc[ih]);
  }
  ...
  event.nhTPCVp = src.nhTPCVp;
  for(int ih=0;ih<event.nhTPCVp;++ih){
    event.tidTPCVp.push_back(src.tidTPCVp[ih]);
    event.pidTPCVp.push_back(src.pidTPCVp[ih]);
    event.didTPCVp.push_back(src.didTPCVp[ih]);
    event.prtTPCVp.push_back(src.prtTPCVp[ih]);
    event.qTPCVp.push_back(src.qTPCVp[ih]);
    event.xTPCVp.push_back(src.xTPCVp[ih]);
    event.yTPCVp.push_back(src.yTPCVp[ih]);
    event.zTPCVp.push_back(src.zTPCVp[ih]);
    event.pxTPCVp.push_back(src.pxTPCVp[ih]);
    event.pyTPCVp.push_back(src.pyTPCVp[ih]);
    event.pzTPCVp.push_back(src.pzTPCVp[ih]);
    event.ppTPCVp.push_back(src.ppTPCVp[ih]);
    event.deTPCVp.push_back(src.deTPCVp[ih]);
    event.tTPCVp.push_back(src.tTPCVp[ih]);
  }
  ...
  event.xtgtHS.push_back(src.VertexOfTrack_x[1]);
  event.ytgtHS.push_back(src.VertexOfTrack_y[1]);
  event.xtgtKurama.push_back(src.VertexOfTrack_x[1]);
  event.ytgtKurama.push_back(src.VertexOfTrack_y[1]);
  ...
  vpK18.push_back(TVector3(event.xtgtHS[0], event.ytgtHS[0], tpc::ZTarget));
  vpK18s.push_back(vpK18);
  
  vector<vector<TVector3>> vpKuramas;
  vector<TVector3> vpKurama;
  vector<double> qKurama = {1.0};
  vpKurama.push_back(TVector3(event.xtgtKurama[0], event.ytgtKurama[0], tpc::ZTarget));
  for(int ih=0; ih<event.nhTPCVp; ++ih){
    if(event.pidTPCVp[ih] == 321 and event.pzTPCVp[ih] > 0){
      vpKurama.push_back(TVector3(event.xTPCVp[ih], event.yTPCVp[ih], event.zTPCVp[ih]));
    }
  }
  vpKuramas.push_back(vpKurama);
  ...
  TPCAna->TrackSearchTPCHelix(vpK18s, vpKuramas, qKurama, ExclusiveTracking);
  Int_t nclTpc = 0;
  ...
  event.isG4Kurama.resize( ntTpc );
  event.isK18.resize( ntTpc );
  event.isG4K18.resize( ntTpc );
...
ConfMan::InitializeHistograms( void )
{
  ...
  tree->Branch( "isG4Kurama", &event.isG4Kurama );
  tree->Branch( "isK18", &event.isK18 );
  tree->Branch( "isG4K18", &event.isG4K18 );
  ...
  tree->Branch( "nhWc", &event.nhWc );
  tree->Branch( "WcSeg", &event.WcSeg );
  tree->Branch( "tWc", &event.tWc );
  tree->Branch( "dtWc", &event.dtWc );
  tree->Branch( "deWc", &event.deWc );
  tree->Branch( "posWc", &event.posWc );
  tree->Branch( "G4tidWc", &event.G4tidWc );
  ...
  TTreeCont[kTPCGeant]->SetBranchAddress("nhWc", &src.nhWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("tidWc", src.tidWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("pidWc", src.pidWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("didWc", src.didWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("prtWc", src.prtWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("qWc", src.qWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("xWc", src.xWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("yWc", src.yWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("zWc", src.zWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("pxWc", src.pxWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("pyWc", src.pyWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("pzWc", src.pzWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("ppWc", src.ppWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("deWc", src.deWc);
  TTreeCont[kTPCGeant]->SetBranchAddress("tWc", src.tWc);
  ...
  TTreeCont[kTPCGeant]->SetBranchAddress("nhTPCVp", &src.nhTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("tidTPCVp", src.tidTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("pidTPCVp", src.pidTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("didTPCVp", src.didTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("prtTPCVp", src.prtTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("qTPCVp", src.qTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("xTPCVp", src.xTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("yTPCVp", src.yTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("zTPCVp", src.zTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("pxTPCVp", src.pxTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("pyTPCVp", src.pyTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("pzTPCVp", src.pzTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("ppTPCVp", src.ppTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("deTPCVp", src.deTPCVp);
  TTreeCont[kTPCGeant]->SetBranchAddress("tTPCVp", src.tTPCVp);
